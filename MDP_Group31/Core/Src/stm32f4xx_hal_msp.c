...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(Left_Encoder2_GPIO_Port, Left_Encoder2_Pin);

    HAL_GPIO_DeInit(Left_Encoder1_GPIO_Port, Left_Encoder1_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, Right_Encoder2_Pin|Right_Encoder1_Pin);
